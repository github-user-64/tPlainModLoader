...
{
    internal class Patch_ModMain
    {
        internal static List<ModMain> mod = new List<ModMain>();

        internal static void Initialize(IAddPatch addPatch)
        {
            Type oType = typeof(Main);
            Type tType = typeof(Patch_ModMain);
        ...
        public static void UpdatePrefix(GameTime gameTime)
        {
            try
            {
                ...
                {
                    foreach (ModMain item in mod) item.OnEnterWorld();
                }

                foreach (ModMain item in mod) item.UpdatePrefix(gameTime);
            }
            catch (Exception ex)
            {
        ...
        public static void UpdatePostfix(GameTime gameTime)
        {
            try
            {
                foreach (ModMain item in mod) item.UpdatePostfix(gameTime);
            }
            catch (Exception ex)
            {
                OutputDebug.OutputException(ex);
        ...
        public static void SetupDrawInterfaceLayersPostfix()
        {
            try
            {
                ...
                foreach (ModMain item in mod) item.SetupDrawInterfaceLayersPostfix(gameInterfaceLayers);
            }
            catch (Exception ex)
            {
                OutputDebug.OutputException(ex);
        ...
        public static void UpdateUIStatesPrefix(GameTime gameTime)
        {
            try
            {
                foreach (ModMain item in mod) item.UpdateUIStatesPrefix(gameTime);
            }
            catch (Exception ex)
            {
                OutputDebug.OutputException(ex);
        ...
        public static void UpdateUIStatesPostfix(GameTime gameTime)
        {
            try
            {
                foreach (ModMain item in mod) item.UpdateUIStatesPostfix(gameTime);
            }
            catch (Exception ex)
            {
                OutputDebug.OutputException(ex);
        ...
        public static void DoUpdateInWorldPrefix(Stopwatch sw)
        {
            try
            {
                foreach (ModMain item in mod) item.DoUpdateInWorldPrefix(sw);
            }
            catch (Exception ex)
            {
                OutputDebug.OutputException(ex);
        ...
        public static void DoUpdateInWorldPostfix(Stopwatch sw)
        {
            try
            {
                foreach (ModMain item in mod) item.DoUpdateInWorldPostfix(sw);
            }
            catch (Exception ex)
            {
                OutputDebug.OutputException(ex);
        ...
        public static void DrawMapPostfix(GameTime gameTime)
        {
            try
            {
                foreach (ModMain item in mod) item.DrawMapPostfix(gameTime);
            }
            catch (Exception ex)
            {
                OutputDebug.OutputException(ex);
        ...
        public static void DrawMenuPrefix(GameTime gameTime)
        {
            try
            {
                foreach (ModMain item in mod) item.DrawMenuPrefix(gameTime);
            }
            catch (Exception ex)
            {
                OutputDebug.OutputException(ex);
            ...
            ref float oldKB, ref int numLines, ref string[] toolTipLine, ref bool[] preFixLine, ref bool[] badPreFixLine)
        {
            try
            {
                foreach (ModMain i in mod) i.MouseText_DrawItemTooltip_GetLinesInfoPostfix(item, ref yoyoLogo, ref researchLine,
