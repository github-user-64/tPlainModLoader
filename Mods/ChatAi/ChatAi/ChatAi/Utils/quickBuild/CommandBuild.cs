...
namespace ChatAi.Utils.quickBuild
{
    ...
    internal static class CommandBuild
    {
        ...
        public static CommandObject CMDBuild(this CommandObject co, string name, GetSetReset<bool> gsr)
        {
            co.SubCommand.Add(get2(name, gsr));
            return co;
        }
        public static CommandObject CMDBuild(this CommandObject co, string name, GetSetReset<int> gsr)
        {
            co.SubCommand.Add(new CommandHRA<int>(name, gsr, new CommandInt()));
            return co;
        }
        public static CommandObject CMDBuild(this CommandObject co, string name, GetSetReset<float> gsr)
        {
            co.SubCommand.Add(new CommandHRA<float>(name, gsr, new CommandFloat()));
            return co;
        }
        public static CommandObject CMDBuild(this CommandObject co, string name, GetSetReset<string> gsr)
        {
            co.SubCommand.Add(new CommandHRA<string>(name, gsr, new CommandString()));
            return co;
        }
    }
}
